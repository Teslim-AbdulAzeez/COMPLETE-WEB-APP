...
async function loadSuggestions() {
  ...
  try {
    ...
    if (suggestedFoods.length === 0) {
      suggestionsGrid.innerHTML = '<p style="color: white; text-align: center; font-size: 1.8rem;">No suggestions found for your current goal. Try changing your goal on the Profile page!</p>';
      return;
    }
